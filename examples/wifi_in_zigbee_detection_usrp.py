...
# Title: Wifi In Zigbee Detection Usrp
# Generated: Sat Jul  7 14:14:13 2018
##################################################
...
class wifi_in_zigbee_detection_usrp(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi In Zigbee Detection Usrp")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Wifi In Zigbee Detection Usrp")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "wifi_in_zigbee_detection_usrp")
        ...
        # Blocks
        ##################################################
        self._zigbee_pdu_length_range = Range(0, 127, 1, 80, 200)
        ...
        self._z_snr_range = Range(-15, 30, 0.1, 15, 200)
        ...
        self._w_snr_range = Range(-15, 30, 0.1, 15, 200)
        ...
        self._sig_gain_range = Range(-15, 10000, 0.1, 20, 200)
        self._sig_gain_win = RangeWidget(self._sig_gain_range, self.set_sig_gain, "sig_gain", "counter_slider", float)
        self.top_layout.addWidget(self._sig_gain_win)
        self._interval_range = Range(10, 10000, 1, 5000, 200)
        ...
        self.wizi_det_zigbee_sync_0 = wizi_det.zigbee_sync(False, 0.75, 500, 10)
        self.wizi_det_wifi_sniffer_0 = wizi_det.wifi_sniffer(False, 0.3, 1, 40)
        ...
        self.uhd_usrp_source_0.set_center_freq(5.26e9, 0)
        self.uhd_usrp_source_0.set_gain(30, 0)
        self.uhd_usrp_source_0.set_antenna('TX/RX', 0)
        self.uhd_usrp_source_0.set_center_freq(2.4e9, 1)
        self.uhd_usrp_source_0.set_gain(30, 1)
        self.uhd_usrp_source_0.set_antenna('TX/RX', 1)
        self.uhd_usrp_sink_0 = uhd.usrp_sink(
        	",".join(('addr=192.168.13.2', "")),
        	uhd.stream_args(
        		cpu_format="fc32",
        		channels=range(1),
        	),
        ...
        self.qtgui_time_sink_x_0_0_1_2 = qtgui.time_sink_f(
        	10000, #size
        	1e6, #samp_rate
        	"", #name
        	1 #number of inputs
        )
        self.qtgui_time_sink_x_0_0_1_2.set_update_time(1)
        self.qtgui_time_sink_x_0_0_1_2.set_y_axis(0, 2)
        
        self.qtgui_time_sink_x_0_0_1_2.set_y_label('Amplitude', "")
        
        self.qtgui_time_sink_x_0_0_1_2.enable_tags(-1, True)
        self.qtgui_time_sink_x_0_0_1_2.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, "")
        self.qtgui_time_sink_x_0_0_1_2.enable_autoscale(True)
        self.qtgui_time_sink_x_0_0_1_2.enable_grid(False)
        self.qtgui_time_sink_x_0_0_1_2.enable_axis_labels(True)
        self.qtgui_time_sink_x_0_0_1_2.enable_control_panel(False)
        
        if not True:
          self.qtgui_time_sink_x_0_0_1_2.disable_legend()
        ...
        for i in xrange(1):
            if len(labels[i]) == 0:
                self.qtgui_time_sink_x_0_0_1_2.set_line_label(i, "Data {0}".format(i))
            else:
        ...
        self.foo_packet_pad_0 = foo.packet_pad(False, False, 0.010, 0, 120)
        (self.foo_packet_pad_0).set_min_output_buffer(96000)
        self.foo_packet_pad2_0 = foo.packet_pad2(False, False, 0.01, 4000, 20000)
        ...
        self.blocks_multiply_const_vxx_0_1_0_0 = blocks.multiply_const_vcc((sig_gain, ))
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/ahyhus/gr-wizi_det/examples/Clear_cor_src.bin', False)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_1_0_0, 0), (self.blocks_complex_to_mag_squared_0, 0))    
        self.connect((self.blocks_multiply_const_vxx_0_1_0_0, 0), (self.blocks_delay_0_0, 0))    
        self.connect((self.blocks_multiply_const_vxx_0_1_0_0, 0), (self.blocks_multiply_xx_0, 0))    
        ...
        self.connect((self.ieee802_11_moving_average_xx_1, 0), (self.qtgui_time_sink_x_0_0_1_2, 0))    
        self.connect((self.ieee802_11_moving_average_xx_1, 0), (self.wizi_det_zigbee_sync_0, 1))    
        self.connect((self.uhd_usrp_source_0, 1), (self.blocks_multiply_const_vxx_0_1_0_0, 0))    
        self.connect((self.uhd_usrp_source_0, 0), (self.blocks_null_sink_0_0_0_0, 0))    
    ...
    def set_sig_gain(self, sig_gain):
        ...
        self.blocks_multiply_const_vxx_0_1_0_0.set_k((self.sig_gain, ))
...
def main(top_block_cls=wifi_in_zigbee_detection_usrp, options=None):
